          ...
          /*   migrationBuilder.CreateTable(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    File_DatastoreId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bases_Datastores_File_DatastoreId",
                        column: x => x.File_DatastoreId,
                        principalTable: "Datastores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bases_Datastores_File_DatastoreId1",
                        column: x => x.File_DatastoreId,
                        principalTable: "Datastores",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bases_FilePath_File_DatastoreId",
                table: "Bases",
                columns: new[] { "FilePath", "File_DatastoreId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bases_File_DatastoreId",
                table: "Bases",
                column: "File_DatastoreId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bases_File_DatastoreId1",
                table: "Bases",
                column: "File_DatastoreId");
